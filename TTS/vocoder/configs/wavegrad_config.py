...
from TTS_my.TTS.vocoder.configs.shared_configs import BaseVocoderConfig
from TTS_my.TTS.vocoder.models.wavegrad import WavegradArgs
...
class WavegradConfig(BaseVocoderConfig):
    ...
    Args:
        ...
        generator_model (str): One of the generators from TTS_my.TTS.vocoder.models.*`. Every other non-GAN vocoder model is
