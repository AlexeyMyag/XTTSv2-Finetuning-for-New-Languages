...
from TTS_my.TTS.tts.layers.align_tts.mdn import MDNBlock
from TTS_my.TTS.tts.layers.feed_forward.decoder import Decoder
from TTS_my.TTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
class AlignTTS(BaseTTS):
    ...
    Examples:
        >>> from TTS_my.TTS.tts.configs.align_tts_config import AlignTTSConfig
    ...
    def get_criterion(self):
        from TTS_my.TTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
