...
from TTS_my.TTS.encoder.configs.speaker_encoder_config import SpeakerEncoderConfig

# from TTS_my.TTS.encoder.configs.emotion_encoder_config import EmotionEncoderConfig
