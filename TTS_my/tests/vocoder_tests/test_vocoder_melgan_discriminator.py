...
from TTS_my.TTS.vocoder.models.melgan_discriminator import MelganDiscriminator
from TTS_my.TTS.vocoder.models.melgan_multiscale_discriminator import MelganMultiscaleDiscriminator
